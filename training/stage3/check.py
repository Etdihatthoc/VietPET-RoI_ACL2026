"""
Dump a CSV with patient_id, region, num_rois, and decoded prompt input for Stage 3 (ROI-only) to inspect batching.
"""
import argparse
import csv
...
def main():
    parser = argparse.ArgumentParser(description="Dump Stage3 val prompts to CSV")
    parser.add_argument("--config", default="config_stage3.yaml", help="Path to config_stage3.yaml")
    parser.add_argument("--output", default="./stage3_inference_inputs.csv", help="Output CSV path")
