...
def generate_predictions(
    ...
    dataloader,
    tokenizer,
    device: torch.device,  # CRITICAL FIX: Must be torch.device object, not string
    ...
    Args:
        ...
        device: torch.device object (NOT string)
    ...
    for batch_idx, batch in pbar:
        ...
        try:
            ...
            for i in range(len(batch["patient_ids"])):
                ...
                # Do NOT slice; just decode the returned ids (we still skip special tokens).
